...
const AdminPage = () => {
	const { fetchUsers, checkAuth} = useAuthStore();

	const { fetchAlbums, fetchSongs, fetchStats, fetchUserSongs , fetchUserAlbums} = useMusicStore();
	...
	useEffect(() => {
		...
		checkAuth();
         fetchUserSongs();
		fetchUserAlbums();
	}, [checkAuth, fetchSongs, fetchAlbums, fetchUserSongs, fetchUserAlbums ]);
