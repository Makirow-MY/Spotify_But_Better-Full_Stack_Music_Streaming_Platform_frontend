...
// // components/AlbumBanner.tsx
// import { Play, Heart, MoreHorizontal, Pause, Clock, ChevronDown } from "lucide-react";
// import { Button } from "@/components/ui/button";
// import { usePlayerStore } from "@/stores/usePlayerStore";
// import { useThemeStore } from "@/stores/useThemeStore";
// import { useState } from "react";
...
//       {/* Main Banner Container */}
//       <div className="relative flex flex-col md:flex-row gap-6 md:gap-8 p-6 md:p-8 rounded-xl overflow-hidden shadow-2xl">
...
//         {/* Album Art - Large with Shadow */}
//         <div className="flex-shrink-0 relative">
//           <div className="w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 shadow-2xl rounded-lg overflow-hidden">
//             <img 
//               src={album.imageUrl || "/placeholder.svg"} 
//               alt={album.title}
...
//             <Button
//               onClick={handlePlayAlbum}
//               className="w-16 h-16 rounded-full bg-green-500 hover:bg-green-400 hover:scale-105 transition-all shadow-xl"
//             >
//               {isCurrentAlbumPlaying ? (
...
//           {/* Album Type Badge */}
//           <p className="text-sm uppercase tracking-wider font-medium mb-2 text-green-400">
//             {album.year ? `${album.year} • Album` : 'Album'}
//           </p>

//           {/* Album Title */}
//           <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold mb-3 tracking-tight">
//             {album.title}
//           </h1>
...
//             <Button
//               onClick={handlePlayAlbum}
//               className="bg-green-500 hover:bg-green-400 text-black font-bold px-8 py-2 rounded-full transition-all hover:scale-105 shadow-lg"
//             >
//               <Play className="h-5 w-5 mr-2 fill-black" />
//               {isCurrentAlbumPlaying ? 'Pause' : 'Play'}
//             </Button>
...
//             >
//               <Heart className={`h-6 w-6 transition-all ${isLiked ? 'fill-green-500 text-green-500' : 'text-white'}`} />
//             </Button>
...
//               {/* Dropdown Menu */}
//               {isMenuOpen && (
//                 <div className={`absolute top-1/2 mt-2 right-0 w-48 rounded-md shadow-lg ${isDark ? 'bg-zinc-800' : 'bg-white'} border ${isDark ? 'border-zinc-700' : 'border-gray-200'} z-50`}>
//                   <div className="py-1">
//                     <button className="w-full text-left px-4 py-2 text-sm hover:bg-white/10 transition flex items-center gap-2">
