...
//   const { signup, login, verifyEmail, isLoading, error } = useAuthStore();
...
//   return (
//     <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[100]">
//       <div className="bg-neutral-900 rounded-2xl p-8 relative">
...
//                   type="text"
//                   placeholder="Full Name"
//                   className="w-full bg-white/70 p-4 rounded-lg"
//                   value={formData.fullName}
//                   onChange={(e) => setFormData({ ...formData, fullName: e.target.value })}
//                   required={!isLogin}
//                 />}
...
//               type="submit"
//               disabled={isLoading}
//               className="w-full bg-green-500 hover:bg-green-600 text-black font-bold py-4 rounded-full transition"
//             >
//               {isLoading ? "Processing..." : isLogin ? "Log In" : "Create Account"}
//             </button>
...
//           // OTP Verification Step
//           <div className="space-y-6">
//             <p className="text-center text-gray-300">We've sent a 6-digit code to {formData.email}</p>
//             <input
//               type="text"
//               maxLength={6}
//               placeholder="Enter OTP"
//               className="w-full bg-white/70 p-4 rounded-lg text-center text-2xl tracking-widest"
//               value={otp}
//               onChange={(e) => setOtp(e.target.value.replace(/\D/g, ""))}
//             />
//             <button
//               onClick={handleVerify}
//               className="w-full bg-green-500 hover:bg-green-600 text-black font-bold py-4 rounded-full"
//             >
//               Verify Email
//             </button>
//             <button
//               onClick={() => useAuthStore.getState().resendOTP(formData.email)}
